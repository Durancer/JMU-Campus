<template>
    <div>
        <el-form ref="registerFormRef" :model="registerForm" :rules="registerRules" label-width="auto"
            ...
            <el-form-item class="from-item" v-for="item in registerFromSetting" :key="item.label" v-bind="item">
                ...
                <el-input v-else class="input-width" v-model="registerForm[item.prop]" v-bind="item.inputArr" />
            </el-form-item>
